class AcltcMailer < ApplicationMailer
  ...
  def lakewood_application_email(application)
    ...
    mail(from: "sandboxd035c758dbb54757b1b13d910d57a6b3.mailgun.org", to: ['theonetrueemailtest@gmail.com', 'dcam1901@gmail.com'], subject: 'Applicant From Lakewood Actualize', reply_to: @lakewood_application.email )
  end
