class AcltcMailer < ApplicationMailer
  ...
  def application_email(application)
    ...
    mail(from: "sandboxd035c758dbb54757b1b13d910d57a6b3.mailgun.org", to: 'theonetrueemailtest@gmail.com', subject: 'Application Submitted', reply_to: "theonetrueemailtest@gmail.com" )
  end
