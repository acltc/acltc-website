module CohortDatesHelper
  def cohort_start_dates
    cohort_dates = [
      ...
      { prework: false, date: Date.new(2018, 7, 22), early_bird_date: nil },
      { prework: true, date: Date.new(2018, 8, 19), early_bird_date: Date.new(2018, 7, 31) },
  ...
  def online_cohort_start_dates
    cohort_dates = [
      ...
      { prework: true, date: Date.new(2018, 7, 22), location: "west", early_bird_date: Date.new(2018, 3, 31) },
