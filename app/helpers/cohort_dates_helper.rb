module CohortDatesHelper
  ...
  def cohort_start_dates
    cohort_dates = [
      ...
      { early_bird: Date.new(2020, 9, 20), prework: Date.new(2020, 9, 20), live: Date.new(2020, 10, 26), location: "Online Day" },
      { early_bird: Date.new(2020, 9, 20), prework: Date.new(2020, 9, 20), live: Date.new(2020, 10, 26), location: "Chicago Day" },
