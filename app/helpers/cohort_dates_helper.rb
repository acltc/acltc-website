module CohortDatesHelper
  def cohort_start_dates
    cohort_dates = [
      ...
      { early_bird: Date.new(2018, 10, 31), prework: Date.new(2018, 12, 2), live: Date.new(2019, 1, 6), location: "Chicago Day" },
      ...
      { early_bird: Date.new(2019, 1, 31), prework: Date.new(2019, 3, 24), live: Date.new(2019, 4, 28), location: "Chicago Day" },
      ...
      { early_bird: Date.new(2019, 5, 31), prework: Date.new(2019, 7, 21), live: Date.new(2019, 8, 18), location: "Chicago Day" },
      ...
      { early_bird: Date.new(2019, 10, 31), prework: Date.new(2019, 12, 1), live: Date.new(2020, 1, 5), location: "Chicago Day" },
      { early_bird: Date.new(2019, 10, 31), prework: Date.new(2019, 12, 1), live: Date.new(2020, 1, 5), location: "Online Day" },
      { early_bird: Date.new(2019, 11, 30), prework: Date.new(2020, 1, 26), live: Date.new(2020, 2, 23), location: "Chicago Night" },
